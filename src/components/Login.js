...
function Signup() {
  ...
  return (
    ...
    <div className='lg:w-[70%] md:w-[50%]'>
      ...
      <p className='text-gray-600 text-xl mb-4'>A whole new productive journey <br /> starts right here</p>
      ...
      <div className='md:flex gap-3 mt-5  inline-flex'>
        ...
        <form className='lg:w-[30%] md:w-[50%]' onSubmit={signIn}>
            <h3 className='font-bold text-2xl text-center'>Login</h3>
            {signin ? <div className='p-3 bg-green-400 text-white font-semibold rounded-lg text-lg shadow-lg'>Successful Logged In</div>: ''}
          ...
          <div className='flex justify-between bg-sky-100 w-90 p-5 rounded-lg my-10 '>
            <input type="password" placeholder='Password' className='outline-0 bg-transparent w-full h-full' onChange={e=>setPassword(e.target.value)} value={password} onKeyDown={clearError} ref={eyeRef}/>
            <span onClick={toggleEye}><FaRegEyeSlash/></span>
          </div>
